...
class Opt:
    def __init__(self):
        ...
        self.root = '/home2/wjx/my_work/Dimple/Dimple-dataset/'  # 数据集根目录
        self.weight_pth = 'FCN_resnet18/{}.pth'
...
if __name__ == '__main__':
    opt = Opt()
    opt.gpu = 0
    opt.weight_pth = 'FCN_resnet18_test4batch/{}.pth'
    main(opt)
